                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="<?= base_url('index.php/auth/login_penyedia'); ?>">
                                ...
                                <div class="text-center">
                                    <a class="small" href="<?= base_url(); ?>index.php/auth/register_penyedia">Daftar Sebagai Penyedia Lapangan!</a>
                                </div> -->
                            </div>
                        </div>
                    </div>
