...
<body>
    <header class="navbar navbar-expand-md navbar-light  p-3  d-print-none" style="background-color: darkgray;">
        <div class=" container ">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#about">
                                ...
                                <span class="nav-link-title d-lg-none d-xl-inline-block">Cara Booking</span>
                            
                            </a>

                        <!-- </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="http://localhost/cakraarenajadwal/">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <span class="nav-link-title d-lg-none d-xl-inline-block">jadwal</span>
