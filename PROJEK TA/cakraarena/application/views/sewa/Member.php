                              ...
                              <div class="row no-gutters">
                                ...
                                <div class="col">
                                  <div class="card-body">
                                    ...
                                    <p class="card-text">Rp<?= $key['harga']; ?> /sesi</p>
                                    <p class="card-text">Alamat: <?= $key['alamat']; ?> /sesi</p>
                                    <p class="card-text">Pemilik: <?= $key['posted_by']; ?></p>
                                    
                                     <div class="">
                                        <a href="detail_futsal/<?= $key['id_futsal']; ?>" class="btn btn-primary">Lihat Detail!</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
